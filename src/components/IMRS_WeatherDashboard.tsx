...
export const IMRS_WeatherDashboard = () => {
  ...
  return (
    ...
    <section className="relative -mt-[53px] overflow-clip rounded-t-[32px] bg-brand-paper pt-16 pb-16 text-brand-ink lg:-mt-[106px] lg:rounded-t-[64px] lg:pt-[120px] lg:pb-[190px]">
      <img
